...
import 'package:img_info_picker/callbacks_enum.dart';
import 'package:img_info_picker/phone_album.dart';
import 'package:img_info_picker/phone_photo.dart';

typedef void MultiUseCallback(dynamic msg);
typedef void CancelListening();

class ImageInfoPicker {
  static const MethodChannel _channel = const MethodChannel('img_info_picker');
